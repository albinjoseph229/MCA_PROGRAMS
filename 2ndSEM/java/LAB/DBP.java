...
public class DBP {
    public static void main(String args[]){
        ...
        try{
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/passwords_db?characterEncoding=utf8","root","");//create a connection to the database specified in the URL 
